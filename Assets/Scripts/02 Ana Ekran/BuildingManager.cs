...
public class BuildingManager : MonoBehaviour
{
    ...
    public void LockingAdjustments()
    {
        foreach (var building in _buildings)
        {
            ...
            {
                ProgressManager.Instance.UnlockAchievement(building.BuildingID, 100);
                building.Achieved = true;
                continue;
            }

            var first = AchievementsManager.Instance.AchievementOf(building.BuildingID);
        ...
        AddSign(AchievementsManager.Instance.CurrentLevelAchievementCompletions);
    }
