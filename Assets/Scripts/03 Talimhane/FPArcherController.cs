...
public class FPArcherController : MonoBehaviour
{
    ...
    [SerializeField] private ArcherMouseLook m_MouseLook;
    ...
    [SerializeField] private AudioClip m_BreathSound; // the sound played when character leaves the ground.
    ...
    {
        m_AudioSource.clip = m_BreathSound;
        m_AudioSource.Play();
    }
